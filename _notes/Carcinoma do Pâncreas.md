...
### Limítrofes
- Envolvimento das vv. mes. superior e/ou porta
- Fix. à mes. sup. <180º
- Fix. à a. hepática
- Oclusão da v. mes. sup. em segmento pequeno
### Não
- Metástases linfonodais fora da área de ressecção
- [[Ascite]]
- Envolvimento vascular amplo
## Tratamento
### Cirúrgico
- Ressecção é o único tto possivelmente curativo
- Para Ca. de Cabeça
	- Gastroduodenopancreatectomia parcial
		- [[Operação de Whipple]]
	- Pancreatoduodenectomia com preservação pilórica
		- [[Operação de Transverso-Longmire]]
- Para Ca. de Corpo e Cauda
	- Pancreatectomia Distal e Esplenectomia
### Neoadjuvante
- Indicação
	- Estádio III borderline ressecável
	- Possibilidade de [[Downstaging]]
	- Melhorar taxas de margens negativas e metástases linfonodais
- Químio/Radioquímioterapia
	- Gentacitabina ou 5Fu isolados
	- 5Fu + Químiorradiação
### Adjuvante
- Menos recidivas
- 1 a 2 meses após operação
### Resistência ao Tratamento
- Redundância de sinalização
- Desmoplasia circundante
- Células tronco do ca. de pâncreas
### [[Cuidados Paliativos]]
#### Objetivos
- Alívio sintomático da [[Icterícia]], [[Obstrução Gástrica]] e dor em pacientes irrececáveis
- Agiliza a terapia sistêmica
- Qualidade de vida
#### Métodos 
##### Não Cirúrgicos
- Descompressão da via biliar por endopróteses
	- Stents metálicos ou plásticos
- Descompressão Percutânea Transparietal Trans-Hepática da Via Biliar
##### Cirúrgicos
- Hepatojejunostomia
	- [[Y de Roux]]
- Gastrojejunostomia
- Bloqueio dos nervos celíacos
	- Neurólise
		- Álcool Absoluto + Bupivacaína
____
# Referências

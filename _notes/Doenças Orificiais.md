...
- Cirúrgico
	- Incisão e Drenagem
		- Ressecção das bordas e destelhamento do abscesso
	- Antibioticoterapia
	- Cuidados locais
## [[Fístula Anorretal]]
- Sepse perianal crônica
- Trajeto comunicando canal anal ou reto ao períneo
- Origem 80-90% criptoglandular
### QC
- Nódulo perianal
- Secreção constante
- Histórico de abscesso anorretal
### Classificação
...
- Orifício externo x O Int.
- Se OE a <3 cm do ânus
- Trajetos arciformes na porção posterior
- Trajetos retilíneos na porção anterior
### Diagnóstico
- EF
- Colonoscopia
- Manometria anal para planejamento cirúrgico
- USG Transrretal
- RNM
- Não se realiza Fistulografia mais
### Tratamento
- Cirúrgico
	- Eliminação da fístula e preservação da função esfincteriana
	- Fistulotomia em 1 ou 2 tempos
## [[Doença Pilonidal]]

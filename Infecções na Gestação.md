...
- Tto adequado à fase clínica & do parceiro
- Sorologia no início do pré-natal e no 3o tri
	- VDRL e TPHA/FTA-Abs
- Sorologia na admissão para parto ou [[Abortamento]]
...
- Penicilina G Benzatina
	- 1º, 2º e Latente
		- 2 ampolas
	- Latente tardia e 3º
		- 2,4 M UI, IM, Semanal por 3 semanas (total de 7,2 MUI)
- Penicilina Cristalina para Neurossífilis
	- 18-24 MUI/dia
### Controle
- Mensalmente 
- O VDRL deve cair 4 vezes em até 6 meses  e negativar entre 12 e 24 meses após tto
## [[Toxoplasmose]]
- Agente
	- _[[Toxoplasma gondii]]_
- 1-3% das gestantes, 80% assintomáticas
- Imunocompetente - Infecção 1a na gestação
- Imunocomprometida - Reativação
### Risco de Transmissão
- 1º Trimestre - 12 a 20%
- 2º Trimestre - 30 a 50%
- 3º Trimestre - 60 a 80%
- Com tratamento - 50%
	- 20% com sequelas graves
### Repercussões Fetais
- [[Tétrade de Sabin]]
...
- [[Hepatoesplenomegalia]]
- Surdez (20%)
- Olhar de Sol Poente = [[Hidrocefalia]]
	- = Ver o branco dos olhos acima da íris
### Interpretação ELISA
- IgM e IgG -
	- Susceptível, orientação clínica
- IgM - e IgG +
	- Imune, rotina de pré-natal
- IgM e IgG +
	- Agd ou Crônica?
		- Teste de Avidez
			- >60% = Crônica
			- <30% Aguda
				- Tto com espiramicina
### PCR do líquido amniótico
- Infectado
	- Sulfadiazina + Primetamina + Ácido Fólico (17 a 33 semana)
		- USG 2/2 semanas, tto pós-natal
- Não-Infectado
	- Espiramicina até termo
	- USG 4/4 sem
	- Testes pós-natais
## [[Rubéola]]
- Transmissão
	- Contato com secreções nasofaríngeas de infectados
...
- Vacinar pós-parto
## [[Hepatites Virais]]
- A e E = Poucas repercussões
- B e C
	- Piores para feto se agudas e quão mais tardio
	- Rastreio (1º e 3º trimestre) com testes sorológicos
	- B não transmite via leite
	- Indicado uso de imunoglobulina hiperimune para B
	- Vacinação e Ig no RN
	- C sem vacina
## [[HIV-AIDS]]
- 920k pessoas vivem com HIV no Brasil
	- 77% fazem tratamento com antiretrovirais
	- 1/3 são mulheres em idade reprodutiva
	- 90% da AIDS em crianças = Transmissão materno-infantil
### Diagnóstico
- Teste rápido
...
- T. Antiretroviral Múltipla + Cesárea eletiva  = <1%
### Fatores que interferem na TV
- Aleitamento
- Carga viral
